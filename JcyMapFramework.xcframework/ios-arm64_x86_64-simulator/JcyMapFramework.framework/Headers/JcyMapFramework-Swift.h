...
#ifndef JCYMAPFRAMEWORK_SWIFT_H
#define JCYMAPFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JcyMapFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// gis包装类，初始化、天地图相关
SWIFT_CLASS("_TtC15JcyMapFramework10JCYMapView")
